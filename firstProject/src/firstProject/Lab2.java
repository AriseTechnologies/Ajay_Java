...
public class Lab2 {
	byte b; // variable and constants demo
	short s; // 0
	int i; // 0
	long l; // 0
	float f; // 0.0
	double d; // 0.0
	char ch; // for 1 character blank space
	boolean b1; // false

	void show1() {
		System.out.println("variables and constants demo");
	...
	void show6() {
		...
		System.out.println("ste2=" + ste2); // ste2=123abc+
